...
-- Note: This runs within the vnstock database context via docker-entrypoint-initdb.d,
-- so CREATE DATABASE/USER for n8n is handled separately.
...
-- Seed data: sample Vietnamese stocks
